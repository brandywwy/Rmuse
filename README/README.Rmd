...
knitr::include_graphics("vignettes/images/example1-1.png")
knitr::include_graphics("vignettes/images/example1-2.png")
```
...
```
```{r echo=FALSE,out.width = "85%"}
knitr::include_graphics("vignettes/images/example2.png")
```
